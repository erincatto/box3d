...
int HelloWorld( void )
{
	...
	groundBodyDef.position = b3MakePosition( (b3Vec3){ 0.0f, -10.0f, 0.0f } );
	...
	bodyDef.position = b3MakePosition( (b3Vec3){ 0.0f, 4.0f, 0.0f } );
	...
	b3Position position = b3Body_GetPosition( bodyId );
...
static int TestSensor( void )
{
	...
	bodyDef.position = b3MakePosition( (b3Vec3){ 1.5f, 11.0f, 0.0f } );
	...
	bodyDef.position = b3MakePosition( (b3Vec3){ 7.39814f, 4.0f, 0.0f } );
	...
	while ( true )
	{
		...
		b3Position bulletPos = b3Body_GetPosition( bulletId );
...
static int TestContactEvents( void )
{
	...
	b3BodyDef bodyDef = b3DefaultBodyDef();
	bodyDef.type = b3_staticBody;
	bodyDef.position = b3MakePosition( (b3Vec3){ 0.0f, -0.5f, 0.0f } );
	...
	bodyDef = b3DefaultBodyDef();
	bodyDef.type = b3_dynamicBody;
	bodyDef.position = b3MakePosition( (b3Vec3){ 0.0f, 5.0f, 0.0f } );
...
static int TestHitEvents( void )
{
	...
	bodyDef.type = b3_dynamicBody;
	bodyDef.gravityScale = 0.0f;
	bodyDef.position = b3MakePosition( (b3Vec3){ 0.0f, 2.0f, 0.0f } );
...
static int TestCompoundHitEvents( void )
{
	...
	for ( int side = 0; side < 2; ++side )
	{
		...
		bodyDef.type = b3_dynamicBody;
		bodyDef.gravityScale = 0.0f;
		bodyDef.position = b3MakePosition( (b3Vec3){ spawnX, 3.0f, 0.0f } );
		bodyDef.linearVelocity = (b3Vec3){ 0.0f, -30.0f, 0.0f };
		b3BodyId sphereBodyId = b3CreateBody( worldId, &bodyDef );
